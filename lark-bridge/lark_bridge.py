...
WORK_DIR = Path(os.environ.get("DSH_WORK_DIR", "/Users/zhoubo/deepseek")).expanduser().resolve()
DSH_BIN = Path(os.environ.get(
    "DSH_BIN",
    "/Users/zhoubo/.npm/_npx/1e7f6d9597241db0/node_modules/@deepseek-ai/dsh/lib/bin.js",
))
